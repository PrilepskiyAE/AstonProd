...
import org.aston.prod.sort.ShuttleSort;
...
@Epic("Тесты класса ShuttleSort")
public class ShuttleSortTest extends BaseTest<ShuttleSort> {
    public ShuttleSortTest() {
        super(ShuttleSort.class);
    }
